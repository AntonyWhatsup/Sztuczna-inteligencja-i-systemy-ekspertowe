...
from visualization import draw_two_mirrored_roofs  # нова функція

# --- Параметри ---
BORDER = 300 # Новий параметр: Відступ від країв даху (мм)
...
# --- Розрахунок окремо для кожного скосу з відступами ---
...
print(f"Кожен скос: {roof_left.width} x {roof_left.length} мм (Відступ: {BORDER} мм)")
...
draw_two_mirrored_roofs(roof_left, roof_right, panel, data_left, data_right)